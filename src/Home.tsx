    ...
    return (
        <Container style={{marginTop: 50}}>
            ...
            <Container maxWidth="sm">
                {/*<h1>Frakt Apes</h1>*/}
                <CustomGrid  container direction="row" justifyContent="center">
                    <a href={"https://twitter.com/FraktApes"} target="_blank" rel="noreferrer" ><i className="fab fa-twitter fa-5x" style={{color: "#fff", marginRight:10}} ></i></a>
                    <a href={"https://discord.gg/SKPeV4k7vh"} target="_blank" rel="noreferrer" ><i className="fab fa-discord fa-5x" style={{color: "#fff", marginLeft:10}}></i></a>
                </CustomGrid>
            </Container>
